...
export default async function AppointmentsPage() {
  ...
  const { data: appointmentsData } = await (supabase as any)
    ...
    .limit(100) as { data: Appointment[] | null }
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">View and manage all booked appointments</p>
      </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {appointment.clients.brand_name || appointment.clients.name}
                        </span>
                        <span className="flex items-center gap-1">
